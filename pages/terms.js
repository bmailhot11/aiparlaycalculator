          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl p-12 border border-gray-700">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <h2 className="text-2xl font-bold text-white mb-6">4. Disclaimers and Limitations</h2>
                ...
                <h2 className="text-2xl font-bold text-white mb-6">7. Payment and Billing</h2>
                <div className="text-gray-300 mb-6 space-y-4">
                ...
                <h2 className="text-2xl font-bold text-white mb-6">8. Privacy Policy</h2>
                <p className="text-gray-300 mb-6">
                ...
                <h2 className="text-2xl font-bold text-white mb-6">9. Responsible Gambling</h2>
