...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - BetGenius</title>
        <meta name="description" content="BetGenius Privacy Policy - How we collect, use, and protect your personal information." />
          ...
          <div className="bg-gray-800 rounded-xl p-8 border border-gray-700 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                BetGenius ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our AI-powered sports betting analysis services.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-gray-900 p-6 rounded-lg border border-gray-600">
                ...
                <ul className="text-gray-300 space-y-2">
                  ...
                  <li><strong className="text-white">Google Analytics:</strong> For website usage analytics (anonymized)</li>
                </ul>
            ...
            <section>
              ...
              <div className="bg-yellow-500/10 p-6 rounded-lg border border-yellow-500/30">
                <ul className="text-yellow-300 space-y-2">
                  <li><strong>Educational Purpose:</strong> BetGenius is an educational and analysis tool only</li>
            ...
            <section>
              ...
              <div className="bg-gray-900 p-6 rounded-lg border border-gray-600">
                ...
                <div className="space-y-2 text-gray-300">
                  <p><strong>Email:</strong> privacy@betgenius.com</p>
