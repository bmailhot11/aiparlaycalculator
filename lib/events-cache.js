...
class EventsCache {
  ...
  async cacheUpcomingEvents(sport) {
    ...
    const sportKeyMap = {
      ...
      'MLS': ['soccer_usa_mls'],
      'UEFA': ['soccer_uefa_champs_league', 'soccer_epl'],
      'Soccer': ['soccer_epl', 'soccer_usa_mls', 'soccer_uefa_champs_league'], // Legacy support
  ...
  getSmartMarkets(sportKey, baseMarkets, includePlayerProps) {
    ...
    const playerPropsMap = {
      'americanfootball_nfl': 'player_pass_tds,player_pass_yds,player_pass_completions,player_pass_attempts,player_pass_interceptions,player_rush_yds,player_rush_attempts,player_rush_tds,player_receptions,player_reception_yds,player_reception_tds,player_kicking_points,player_field_goals,player_tackles_assists,player_1st_td,player_anytime_td',
      'americanfootball_nfl_preseason': 'player_pass_yds,player_rush_yds,player_receptions,player_anytime_td',
      'americanfootball_ncaaf': 'player_pass_yds,player_pass_tds,player_rush_yds,player_rush_tds,player_reception_yds,player_receptions,player_anytime_td',
      'basketball_nba': 'player_points,player_rebounds,player_assists,player_threes,player_blocks,player_steals,player_turnovers,player_pts_rebs_asts,player_double_double,player_triple_double',
      'basketball_nba_preseason': 'player_points,player_rebounds,player_assists,player_threes',
      'basketball_ncaab': 'player_points,player_rebounds,player_assists,player_threes,player_pts_rebs_asts',
      'icehockey_nhl': 'player_goals,player_assists,player_points,player_shots,player_hits,player_blocked',
      'icehockey_nhl_preseason': 'player_goals,player_assists',
      'baseball_mlb': 'player_hits,player_home_runs,player_total_bases,player_rbis,player_runs,player_hits_runs_rbis,player_strikeouts,player_singles,player_doubles,player_triples,player_stolen_bases,pitcher_strikeouts,pitcher_outs'
    };
  ...
  async fetchOddsWithFallback(sportKey, fullMarkets, API_KEY) {
    ...
    // First attempt: try with player props
    try {
