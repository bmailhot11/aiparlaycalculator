...
class EventsCache {
  ...
  getSmartMarkets(sportKey, baseMarkets, includePlayerProps) {
    ...
    const playerPropsMap = {
      'americanfootball_nfl': 'player_pass_yds,player_rush_yds,player_reception_yds,player_pass_tds,player_rush_tds,player_reception_tds,player_receptions',
      'americanfootball_nfl_preseason': 'player_pass_yds,player_rush_yds,player_reception_yds',
      'americanfootball_ncaaf': 'player_pass_yds,player_rush_yds,player_reception_yds,player_pass_tds,player_rush_tds,player_reception_tds',
      ...
      'basketball_ncaab': 'player_points,player_rebounds,player_assists,player_threes,player_blocks',
      ...
      'baseball_mlb': 'batter_hits,batter_home_runs,batter_rbis,pitcher_strikeouts,batter_total_bases'
    };
  ...
  async fetchOddsWithFallback(sportKey, fullMarkets, API_KEY) {
    // Use ALL regions for maximum sportsbook coverage for arbitrage
