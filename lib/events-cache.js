...
class EventsCache {
  ...
  getSmartMarkets(sportKey, baseMarkets, includePlayerProps) {
    ...
    const playerPropsMap = {
      'americanfootball_nfl': 'player_pass_yds,player_rush_yds,player_reception_yds,player_pass_tds,player_rush_tds',
      'americanfootball_nfl_preseason': 'player_pass_yds,player_rush_yds', // Limited for preseason
      'americanfootball_ncaaf': 'player_pass_yds,player_rush_yds,player_reception_yds',
      'basketball_nba': 'player_points,player_rebounds,player_assists,player_threes,player_double_double',
      ...
      'baseball_mlb': 'batter_hits,batter_rbis,batter_runs_scored,pitcher_strikeouts'
    };
