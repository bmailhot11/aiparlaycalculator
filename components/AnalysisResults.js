...
export default function AnalysisResults({ analysis }) {
  ...
  if (analysis.error_type === 'vision_parsing_error') {
    return (
      <div className="mt-8 bg-red-50 border border-red-200 rounded-xl p-4 md:p-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 md:p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 mb-6">
            <div className="text-center p-2 md:p-3 bg-gray-50 rounded-lg">
              <div className="text-lg md:text-2xl font-bold text-gray-800">{betSlipDetails.total_odds || 'N/A'}</div>
              <div className="text-xs md:text-sm text-gray-600">Total Odds</div>
            </div>
            <div className="text-center p-2 md:p-3 bg-gray-50 rounded-lg">
              <div className="text-lg md:text-2xl font-bold text-green-600">{betSlipDetails.total_stake || 'Not visible'}</div>
              <div className="text-xs md:text-sm text-gray-600">Your Stake</div>
            </div>
            <div className="text-center p-2 md:p-3 bg-gray-50 rounded-lg">
              <div className="text-lg md:text-2xl font-bold text-purple-600">{betSlipDetails.potential_payout || 'Not visible'}</div>
              <div className="text-xs md:text-sm text-gray-600">Potential Payout</div>
            </div>
            <div className="text-center p-2 md:p-3 bg-gray-50 rounded-lg">
              <div className="text-lg md:text-2xl font-bold text-blue-600">{betSlipDetails.bet_type || betSlipDetails.bet_structure || 'Unknown'}</div>
              <div className="text-xs md:text-sm text-gray-600">Bet Type</div>
            </div>
          </div>
